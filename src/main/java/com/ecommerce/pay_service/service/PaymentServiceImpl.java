...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentDto processPayment(RequestPayment request, String userId) {
        ...
        request.getItems().forEach(item ->
                paymentEntity.addPaymentItem(item.getProductId(), item.getUnitPrice(), item.getQty())
        );
    ...
    private KakaoReadyResponse callKakaoReady(RequestPayment request, String userId, Integer totalAmount) {
        ...
        params.put("approval_url", "http://localhost:8000/payment-service/payment/success");
        params.put("cancel_url", "http://localhost:8000/payment-service/payment/cancel");
        params.put("fail_url", "http://localhost:8000/payment-service/payment/fail");
